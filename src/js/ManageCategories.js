...
export function ManageCategories ( { categories, budget } ) {
    return (
        <>
...
function NewCategory ( { budget, value = "", onChange  } ) {
    ...
    return (
        <>
            ...
            {budget.base_ccy}
            <button type ='button' onClick={() => addCategory({username, uuid_budget, name, amount})}>Add New</button>
            <br></br>
            <br></br>
        </>
