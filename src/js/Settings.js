				...
				<form onSubmit={handleSubmit}>
					...
					<section className="conversionTypes">
						...
						<input
							...
							checked={userPreferences.manualConversion}
							onChange={handleChange}
						></input>
					...
					<section className="currencyFormat">
						...
						<label htmlFor="before">
							...
							<input
								...
								name="currencyFormat"
								value="before"
								checked={userPreferences.currencyFormat === "before"}
								onChange={handleChange}
							/>
						</label>
						<label htmlFor="after">
							...
							<input
								...
								name="currencyFormat"
								value="after"
								checked={userPreferences.currencyFormat === "after"}
								onChange={handleChange}
							/>
						</label>
						<label htmlFor="neither">
							Don't display symbol (123,456.78)
							<input
								type="radio"
								name="currencyFormat"
								value="neither"
								checked={userPreferences.currencyFormat === "neither"}
								onChange={handleChange}
							/>
						</label>
					</section>
